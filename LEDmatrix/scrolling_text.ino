...
LedControl lc=LedControl(0,1,2,numDevices);
//Pin 12/0 is connected to the DATA IN-pin of the first MAX7221
//Pin 11/1 is connected to the CLK-pin of the first MAX7221
//Pin 10/2 is connected to the LOAD(/CS)-pin of the first MAX7221
 
 
const unsigned char scrollText[] PROGMEM ={" 32x8 LED matrix on ATtiny85  "};
